  ...
  try {
    ...
    const achievements = await db
      .select({
        ...
        workstreamSource: achievement.workstreamSource,
        ...
        sourceItemType: achievement.sourceItemType,
        standupDocumentId: achievement.standupDocumentId,
        ...
        embeddingModel: achievement.embeddingModel,
        embeddingGeneratedAt: achievement.embeddingGeneratedAt,
        company: {
          id: company.id,
          name: company.name,
