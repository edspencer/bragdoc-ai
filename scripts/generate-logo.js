...
// Draw "BragDoc" text in white - LARGE TEXT
const textX = iconX + iconSize + 20;
const textY = height / 2;
ctx.fillStyle = 'rgb(255, 255, 255)'; // Pure white
ctx.font = 'bold 85px Arial, sans-serif'; // Use bold
ctx.textAlign = 'left';
ctx.textBaseline = 'middle';
console.log('Drawing text at:', textX, textY, 'with font:', ctx.font);
ctx.fillText('FrameIt', textX, textY);
console.log('Text drawn with fillStyle:', ctx.fillStyle);
console.log('Text metrics:', ctx.measureText('BragDoc'));

// Save the PNG
const outputPath = path.join(
  __dirname,
  '../apps/marketing/public/bragdoc-logo.png',
);
