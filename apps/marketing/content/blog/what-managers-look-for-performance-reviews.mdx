...
If you want to make this systematic—having documentation ready throughout the year rather than scrambling before review season, check out the [six types of developer impact](/blog/six-types-developer-impact) you should be documenting.
