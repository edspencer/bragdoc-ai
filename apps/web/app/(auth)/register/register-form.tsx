...
export function RegisterForm({ isDemoFlow }: RegisterFormProps) {
        ...
        {isDemoFlow && (
          <div className="px-4 sm:px-16 text-center">
            <p className="text-sm text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950 py-2 px-4 rounded-lg">
              After signing up, you'll enter demo mode with sample data to
              explore
            </p>
          </div>
        )}
        <div className="flex flex-col gap-6">
          ...
          <div className="px-4 sm:px-16">
            ...
            <p className="text-center text-sm text-gray-600 mt-4 dark:text-zinc-400">
              ...
              <Link
                href={isDemoFlow ? '/login?demo=true' : '/login'}
