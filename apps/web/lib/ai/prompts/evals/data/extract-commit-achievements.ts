...
export const expectedAchievementsFromNoisyCommits: ExtractedAchievement[] = [
  ...
  },
  {
    ...
    details:
      'Fixed issues in the build process, ensuring it works correctly again.',
    eventStart: lastMidnight,
    eventEnd: nextMidnight,
    impactSource: 'llm',
    impactUpdatedAt: new Date(),
  ...
  },
  {
    ...
    details:
      'Improved the evaluation process for extracting achievements in the project.',
    eventStart: lastMidnight,
    eventEnd: nextMidnight,
    impactSource: 'llm',
    impactUpdatedAt: new Date(),
...
export const expectedAchievementsFromQualityCommits: ExtractedAchievement[] = [
  ...
  {
    summary:
      'Integrated Stripe for payment processing, though webhook issues remain',
    details:
      'Integrated Stripe for payment processing, though webhook issues remain',
    eventStart: lastMidnight,
    eventEnd: nextMidnight,
  ...
  {
    summary:
      'Cleanup and minor fixes in Beta version, including evals functionality',
    details:
      'Cleanup and minor fixes in Beta version, including evals functionality',
    eventStart: lastMidnight,
    eventEnd: nextMidnight,
