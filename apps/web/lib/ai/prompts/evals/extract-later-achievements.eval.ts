...
const chatHistory = [
  ...
  },
  {
    ...
    content:
      "Ok, I've recorded your process achievement. Would you like to add any additional context about the impact or process?",
    id: '2',
  },
  {
    role: 'user' as const,
    ...
    expected: [
      {
        ...
        details:
          "Added the Documents CRUD pages for logged in users - so a user can see all of the documents that they've created, and edit them without having to go back through the chat",
      ...
      },
      {
        ...
        details:
          'Removed the Github Repo management UI as it was vestigial at this point',
        eventStart: lastMidnight,
        eventEnd: nextMidnight,
        impactSource: 'llm',
        impactUpdatedAt: new Date(),
      ...
      },
      {
        ...
        details:
          'Implemented the new homepage design and tested out the Stripe integration in production',
        eventStart: lastMidnight,
        eventEnd: nextMidnight,
        impactSource: 'llm',
        impactUpdatedAt: new Date(),
      ...
      },
      {
        ...
        details:
          'Updated the README in the BragDoc repo to make it easier for new developers to get up and running',
        eventStart: lastMidnight,
        eventEnd: nextMidnight,
        impactSource: 'llm',
        impactUpdatedAt: new Date(),
