...
export const Context = ({ className, usage, ...props }: ContextProps) => {
  ...
  // Note: Usage context tracking not fully implemented yet
  const usageWithContext = usage as any;
  const max =
        ...
        <div className="min-w-[240px] space-y-2">
          ...
          <div className="mt-1 space-y-1">
            ...
            <InfoRow
              ...
              label="Input"
              tokens={usageWithContext?.inputTokens ?? usage?.promptTokens}
            />
            <InfoRow
              costText={usageWithContext?.costUSD?.outputUSD?.toString()}
              label="Output"
              tokens={usageWithContext?.outputTokens ?? usage?.completionTokens}
            />
            <InfoRow
            ...
            />
            {usageWithContext?.costUSD?.totalUSD !== undefined && (
              <>
