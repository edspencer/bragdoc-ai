...
export const AchievementCreated = memo(
  function AchievementCreated({ achievement }: { achievement: any }) {
    return (
      <div
        className="bg-slate-100 border border-slate-400 text-slate-700 px-2 py-1 rounded-md relative max-w-54"
        role="alert"
      >
