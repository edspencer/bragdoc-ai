    ...
    <Container className="relative">
      <div className="mx-auto max-w-3xl pt-16 pb-24">
        ...
        <div className="prose dark:prose-invert">
          ...
          <h2>Introduction</h2>
          <p>
            At bragdoc.ai, we take your privacy seriously. This Privacy Policy explains how we collect, use, 
          ...
          <p>
            If you choose to connect your GitHub account, we collect:
          </p>
          <ul>
          ...
          <p>
            As you use bragdoc.ai, we collect:
          </p>
          <ul>
          ...
          <p>
            Your data is stored securely in our database hosted on Vercel&apos;s infrastructure. We implement 
          ...
          <p>
            ...
            cookies to understand how you use our service and improve it.
          </p>
