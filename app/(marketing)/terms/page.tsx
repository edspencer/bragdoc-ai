    ...
    <Container className="relative">
      <div className="mx-auto max-w-3xl pt-16 pb-24">
        ...
        <div className="prose dark:prose-invert">
          ...
          <p>
            By accessing or using bragdoc.ai (&quot;the Service&quot;), you agree to be bound by these Terms of Service 
          ...
          <h2>2. Use License</h2>
          <p>
            We grant you a personal, non-transferable, non-exclusive license to use the Service subject to 
            these Terms. This license is conditioned on your compliance with our usage guidelines and 
            subscription terms.
          </p>
          ...
          <p>
            Paid subscriptions provide additional features including:
          </p>
          <ul>
          ...
          <p>
            When using our GitHub integration features:
          </p>
          <ul>
            <li>You must comply with GitHub&apos;s terms of service</li>
            <li>You are responsible for managing repository access permissions</li>
            <li>We are not responsible for any unintended data exposure due to incorrect permission settings</li>
          </ul>

          <h2>4. User Content</h2>
          <p>
            You retain all rights to your content. By using the Service, you grant us a license to:
          </p>
          <ul>
          ...
          <p>
            These Terms are governed by the laws of the jurisdiction in which bragdoc.ai operates, 
