...
const features = [
  {
    title: 'AI-Powered Achievement Tracking',
    description:
      'Our AI automatically identifies and extracts achievements from your messages, ensuring nothing gets missed.',
    image: '/images/screenshots/feature-1.png',
  },
  {
    title: 'GitHub Integration',
    description:
      'Automatically pull achievements from your commit messages and pull request descriptions to build a comprehensive record of your technical contributions.',
    image: '/images/screenshots/feature-2.png',
  },
  {
