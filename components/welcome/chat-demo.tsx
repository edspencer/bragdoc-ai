...
const achievementsInTool = [
  {
      ...
      "details": "Refactored the chat user interface to properly display new achievements. This involved modifying the existing UI components and logic to accommodate the new achievement display format and styling.",
  ...
  },
  {
      ...
      "summary": "Enabled saving of achievement data to the database for persistence.",
      "details": "Implemented the functionality to save achievement data to the database. This involved creating the necessary database schema and API endpoints to handle the storage and retrieval of achievement information.",
      "eventStart": "2024-12-23T00:00:00.000Z",
      "eventEnd": null,
      "eventDuration": "day",
      "isArchived": false,
  ...
  },
  {
      ...
      "details": "Developed the initial functionality for generating summary documents. This involved creating the necessary logic to extract relevant information and format it into a document.",
      "eventStart": "2024-12-23T00:00:00.000Z",
      "eventEnd": null,
      "eventDuration": "day",
      "isArchived": false,
...
const allMessages = [
  ...
  },
  {
      ...
      "role": "assistant",
      "content": "I've saved your achievements for today. If you need to generate a report or document based on these achievements, just let me know!",
      "toolInvocations": []
  }
]
  ...
  React.useEffect(() => {
    ...
    if (achievementIndex >= achievementsInTool.length) {
      ...
      const finalTimeout = setTimeout(() => {
        setMessages(prevMessages => [...prevMessages, allMessages[2] as Message]);
      }, 500);
    ...
    const timeout = setTimeout(() => {
      setMessages(prevMessages => {
        ...
        const toolInvocation = lastMessage.toolInvocations[0] as { result: { achievements: typeof achievementsInTool } };
