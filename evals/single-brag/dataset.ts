...
export const singleAchievementExamples: Conversation[] = [
  ...
  {
    "description": "Casual achievement with metrics",
  ...
  {
    "description": "Team achievement with metrics",
  ...
  {
    "description": "Technical achievement with metrics",
  ...
  {
    "description": "Leadership achievement with metrics",
